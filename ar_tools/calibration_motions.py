...
def head(rclpy_init_args=None):
    ...
    periodic_trajectory_pt_msg_1_.joint_space_commands.append(generate_joint_space_command_msg(JointName.NECK_PITCH, 0.4))
    periodic_trajectory_pt_msg_1_.task_space_commands.append(generate_task_space_command_msg(ReferenceFrameName.PELVIS, ReferenceFrameName.BASE, [ 0.05, -0.1, 0.9, 0.2, -0.1, 0.4 ]))

    cumulative_seconds_from_start_ = cumulative_seconds_from_start_ + 1
    periodic_trajectory_pt_msg_2_ = WholeBodyTrajectoryPoint(time_from_start=Duration(sec=cumulative_seconds_from_start_))
    periodic_trajectory_pt_msg_2_.joint_space_commands.append(generate_joint_space_command_msg(JointName.NECK_PITCH, 0.4))
    periodic_trajectory_pt_msg_2_.task_space_commands.append(generate_task_space_command_msg(ReferenceFrameName.PELVIS, ReferenceFrameName.BASE, [ 0.05, 0.1, 0.9, -0.2, 0.1, -0.4 ]))
    ...
    periodic_trajectory_pt_msg_3_.joint_space_commands.append(generate_joint_space_command_msg(JointName.NECK_PITCH, 0.0))
    periodic_trajectory_pt_msg_3_.task_space_commands.append(generate_task_space_command_msg(ReferenceFrameName.PELVIS, ReferenceFrameName.BASE, [ -0.05, 0.1, 0.7, 0.2, -0.1, -0.4 ]))
    
    cumulative_seconds_from_start_ = cumulative_seconds_from_start_ + 1
    periodic_trajectory_pt_msg_4_ = WholeBodyTrajectoryPoint(time_from_start=Duration(sec=cumulative_seconds_from_start_))
    periodic_trajectory_pt_msg_4_.joint_space_commands.append(generate_joint_space_command_msg(JointName.NECK_PITCH, 0.0))
    periodic_trajectory_pt_msg_4_.task_space_commands.append(generate_task_space_command_msg(ReferenceFrameName.PELVIS, ReferenceFrameName.BASE, [ 0.05, -0.1, 0.7, -0.2, 0.1, 0.4 ]))
    
    # an extra message to make sure the trajectory ends in a safe position
    cumulative_seconds_from_start_ = cumulative_seconds_from_start_ + 2
    periodic_trajectory_pt_msg_5_ = generate_datum_pose_trajectory_point_msg(cumulative_seconds_from_start_)
    
    run_routine(rclpy_init_args, [ periodic_trajectory_pt_msg_1_, periodic_trajectory_pt_msg_2_, periodic_trajectory_pt_msg_3_, periodic_trajectory_pt_msg_4_, periodic_trajectory_pt_msg_5_ ])
